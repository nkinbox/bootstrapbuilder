@push('nodes')
<a href="#component_{{$element->node.'_'.$element->id}}" class="list-group-item list-group-item-action" data-toggle="collapse" tabindex="20"><i class="fa fa-cube"></i> {{$element->node.'_'.$element->id}}</a>
@endpush
...
<input type="hidden" name="order[{{$element->id}}]" value="{{$element->order}}">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="input-group mb-3">
                ...
                <select class="custom-select" tabindex="1" name="type[{{$element->id}}]">
