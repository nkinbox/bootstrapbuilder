...
<div class="card">
    <div class="card-body">
        ...
        <div class="card-text">
            @if($component)
                @if($operation == "edit")
                <form action="{{ route('Template.Page.Component.edit') }}" method="post">
                        ...
                        $.getJSON('{{ route('LoadComponents.component') }}', function(response, status){
                            if(status == "success") {
                                ...
                                $(".useComponent").click(function(e){
                                    e.preventDefault();
                                    var display = $("#ComponentContainer");
                                    window.location = '{{ route('Template.Page.Component', ['page_id' => $page->id, 'operation' => 'add']).'/' }}' + $(this).attr("data-name");
