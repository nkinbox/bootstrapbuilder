<div>
    <div class="input-group mb-3">
        ...
        <input name="hotel_name" type="text" value="{{ old('hotel_name', ((isset($default) && $default)?$default:'')) }}" class="form-control" placeholder="Hotel Name" tabindex="1" list="hotel_list" autocomplete="off">
